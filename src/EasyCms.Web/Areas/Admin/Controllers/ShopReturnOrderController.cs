...
namespace EasyCms.Web.Areas.Admin.Controllers
{
    public class ShopReturnOrderController : Controller
    {
        ...
        //
        // POST: /Admin/ShopReturnOrder/Create
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult Save(FormCollection collection)
        {
            ...
            try
            {
                if (collection["RecordStatus"] != "add")
                {
                    ...
                    p.BindForm<ShopReturnOrder>(collection);
                }
                else
                {
                    // TODO: Add insert logic here
                    p = collection.Bind<ShopReturnOrder>();
        ...
        //
        // GET: /Admin/ShopReturnOrder/Edit/5
        ...
        [HttpPost]
        //
        // GET: /Admin/ShopReturnOrder/Delete/5
