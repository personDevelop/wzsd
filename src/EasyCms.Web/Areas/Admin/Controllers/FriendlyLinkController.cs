...
namespace EasyCms.Web.Areas.Admin.Controllers
{
    ...
    {
        FriendlyLinkBll bll = new FriendlyLinkBll();
        //
        // GET: /Admin/FriendlyLink/
        ...
        //
        // POST: /Admin/FriendlyLink/Create
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult Save(FormCollection collection)
        {
            ...
            try
            {
                if (collection["RecordStatus"] != "add")
                {
                    ...
                    p.BindForm<FriendlyLink>(collection);
                }
                else
                {
                    // TODO: Add insert logic here
                    p = collection.Bind<FriendlyLink>();
        ...
        [HttpPost]
        //
        // GET: /Admin/FriendlyLink/Delete/5
