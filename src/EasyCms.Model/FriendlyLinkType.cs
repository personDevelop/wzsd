...
namespace EasyCms.Model
{
    ...
    /// </summary>  
    [JsonObject]
    public partial class FriendlyLinkType : BaseEntity
    {
        public static Column _ = new Column("FriendlyLinkType");

        public FriendlyLinkType()
        {
            this.TableName = "FriendlyLinkType";
            OnCreate();
        }
